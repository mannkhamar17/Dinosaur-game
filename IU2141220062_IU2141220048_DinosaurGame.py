...
class Dinosaur:
    ...
    def duck(self):
        self.image = self.duck_img[self.step_index // 5]         #changing of image
        self.dino_rect = self.image.get_rect()
        self.dino_rect.x = self.X_POS
...
def main():
    ...
    y_pos_bg = 380
    points = 0
    font = pygame.font.SysFont('cansolas.ttf', 30)
    obstacles = []
    death_count = 0
...
def menu(death_count):
    ...
    run = True
    while run:
        SCREEN.fill((255, 255, 255))                                         #start menu
        font = pygame.font.SysFont('cansolas.ttf', 40)
